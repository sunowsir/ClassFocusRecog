...
#ifndef _OCSFS_FACE_RECOGNITION_H
#define _OCSFS_FACE_RECOGNITION_H
...
public: 
    OCSFS_Face_Recognition(const QString&, const QString&);
    ~OCSFS_Face_Recognition();
