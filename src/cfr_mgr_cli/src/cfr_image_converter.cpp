...
CFR_Image_Converter::CFR_Image_Converter() {
}

CFR_Image_Converter::~CFR_Image_Converter() {
}

bool CFR_Image_Converter::qimage_2_mat(const QImage& image, cv::Mat& mat) {
    switch (image.format()) {
...
bool CFR_Image_Converter::mat_2_qimage(const cv::Mat& mat, QImage& image) {
